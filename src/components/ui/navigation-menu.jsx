...
function NavigationMenuLink({ className, ...props }) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex items-center gap-1.5 rounded-2xl p-3 text-sm text-sidebar-foreground transition-all outline-none hover:bg-chart-4/60 hover:text-sidebar-foreground focus:bg-chart-4/60 focus:text-sidebar-foreground focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-xl data-[active=true]:bg-chart-4/40 data-[active=true]:text-sidebar-foreground data-[active=true]:hover:bg-chart-4/60 data-[active=true]:focus:bg-chart-4/60 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
